...
public class modifyPass extends javax.swing.JFrame {
    ...
    private void changeMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_changeMouseClicked
        try {
            ...
            String query = "SELECT * FROM admin_staff WHERE a_id = '"+ses.getId()+"'";
            ResultSet rs = db.getData(query);
            if(rs.next()) {
                String oldpass = rs.getString("a_pass");
                ...
                if(oldpass.equals(oldhash)) {
                    ...
                    if(npass.equals(cpass) && npass.length() >= 8) {
                        ...
                        db.updateData("UPDATE admin_staff SET a_pass = '"+hashedNPass+"' WHERE a_id = '"+ses.getId()+"'");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(modifyPass.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new modifyPass().setVisible(true);
            }
        });
    }
